...
*>
*  =====================================================================
      SUBROUTINE ZGEQR2_REF( M, N, A, LDA, TAU, WORK, INFO )
*
...
*     .. External Subroutines ..
      EXTERNAL           XERBLA, ZLARF_REF, ZLARFG_REF
*     ..
*     .. Intrinsic Functions ..
...
*
         CALL ZLARFG_REF( M-I+1, A( I, I ), A( MIN( I+1, M ), I ), 1,
     $                TAU( I ) )
         IF( I.LT.N ) THEN
*
...
*
            ALPHA = A( I, I )
            A( I, I ) = ONE
            CALL ZLARF_REF( 'Left', M-I+1, N-I, A( I, I ), 1,
