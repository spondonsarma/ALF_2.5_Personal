...
\begin{figure}
        \begin{center}
                \includegraphics[width=.25\textwidth]{Figures/Square.pdf}
                \includegraphics[width=.33\textwidth]{Figures/Square_bilayer.pdf} 
                \includegraphics[width=.31\textwidth]{Figures/N-Leg-Lad.pdf} \\
                 \includegraphics[width=.35\textwidth]{Figures/Honeycomb.pdf} 
 		\includegraphics[width=.35\textwidth]{Figures/Honeycomb_bilayer.pdf}
				
                \caption{Predefined lattices in ALF: Left to right, top row: square, bilayer square and 3-leg ladder; bottom row: honeycomb and bilayer honeycomb. Nontrivial unit cells are shown as gray regions, while gray sites belong to the second layer in bilayer systems}
