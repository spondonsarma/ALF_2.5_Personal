...
\begin{table}[h]
  ...
  \texttt{Test\_Hub\_Template/} & A template for the Hubbard model\\
...
\end{table}
%
The output files are listed in table~\ref{table:output}. The output format for the equal-time, scalar observables is as follows:\\
