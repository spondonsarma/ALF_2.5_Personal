...
\FAcomment{FA.  I  plan to write the following. SU(2) Hubbard on Honeycomb lattice.  MZ Hubbard. Both will be rather short.  
I will also extend the Hubbard model module to include the Honeycomb lattice.  This is done}
