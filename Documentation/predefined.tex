...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{interaction_vertices}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{predefined_observables}
\input{dimer_and_cotunneling} %temporary, to be merged into predefined_observables
\input{renyi} %temporary, to be merged into predefined_observables
%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{trial_wave_function}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
