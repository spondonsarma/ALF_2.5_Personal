...
Eq.~(\ref{rhoA}) is the starting point for computing the entanglement Hamiltonian \cite{Toldin18} and the R\'enyi entropies \cite{Grover13,Assaad13a}. ALF provides predefined observables to compute the second R\'enyi entropy and its associated mutual information, see Sec.~\ref{sec:renyi}.
