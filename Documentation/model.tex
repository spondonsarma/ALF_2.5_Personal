...
Upon evenly discretizing the imaginary axis and upon applying a Hubbard-Stratonovich  transformation \cite{Hubbard59} to the interacting  (two-body) imaginary-time propagators,  
...
\end{equation}
Note that the chemical potential term is already included in the definition of the one-body term $\hat{\mathcal{H}_{T}}$ (\ref{eqn:general_ham_t}) of the general Hamiltonian.  
