...
However the simulations suggest that 
 ...
 \end{equation} 
 at low temperatures  where  $N$  corresponds  to size of the lattice.  Thereby, the constraint is dynamically imposed and   simulations of the attractive Hubbard model with  \texttt{Hamiltonian\_Examples.f90}  should yield identical results. To test this,  we have computed equal time Green functions:
\begin{equation}
