...
The pyALF script used to produce the data of  the plot can be found in \href{https://git.physik.uni-wuerzburg.de/ALF/ALF/-/blob/\pyALFbranch/Documentation/Figures/Kondo/Kondo.py}{\texttt{Kondo.py}}  }
