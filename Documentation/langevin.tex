...
\end{equation}
with $\hat{F}$ being a transformation to independent modes of the field. This generically corresponds to a Fourier transform, thus the name. Currently an implementation of Fourier acceleration is not available in ALF, but can be included by the user.
