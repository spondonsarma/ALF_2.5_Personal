...
{\color{red}   @Jefferson. This cannot really be, since somewhere you have to  specify the number of  mpi  process.    I think that it would be good to use the standards defined by pyALF. }
