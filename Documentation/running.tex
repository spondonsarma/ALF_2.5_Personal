...
\red{Update file "parameter" in ALF master branch.}\\
...
To run serially the simulation for a given model, for instance one of the Hubbard models included in \texttt{Hamiltonian\_Examples\_mod.F90}, described in Sec.~\ref{sec:hubbard}, issue the command
\begin{lstlisting}[style=bash]
