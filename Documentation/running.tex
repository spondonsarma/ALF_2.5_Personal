...
%-------------------------------------------------------------------------------------
%
The environment variables and the directives to compile the code are set in the following makefile \texttt{Makefile}:  [NOW A GOOD PART OF THIS IS IN THE SCRIPT configureHPC.sh -- Update]
\lstset{style=bash}
\begin{lstlisting}
