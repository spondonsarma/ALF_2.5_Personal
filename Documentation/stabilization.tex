...
In order to guarantee that in every numerical step the evolution remains Hermitian, one should make sure that the hopping and interaction terms are decomposed symmetrically.
...
\begin{itemize}
	...
	\item the propagation for one step reads:
\begin{align}
