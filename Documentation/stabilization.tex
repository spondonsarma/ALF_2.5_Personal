...
\end{equation}
$\bm{D}_i$ now contains the row norms of the original $\tilde{\bm{R}}_i$ matrix and hence separates off the total scales of the problem since $\tilde{\bm{R}}_i$ is now only of modest condition number.  \mycomment{ FFA. You are guessing this.}
