...
Which returns:
\begin{align}
\texttt{Obs} = \langle N_i  N_j \rangle - \langle N_i\rangle  \langle N_j\rangle,
\end{align}
where
\begin{align}
N_i = \sum_{\sigma=1}^{N_\text{col}} \sum_{s=1}^{N_\text{fl}}  c^{\dagger}_{i,\sigma,s} c_{i,\sigma,s}.
\end{align}
...
Which returns:
\begin{align}
\texttt{Obs} = \sum_{\sigma=1}^{N_\text{col}} \sum_{s=1}^{N_\text{nf}} \langle  c^{\dagger}_{i,\sigma,s}(\tau) c_{j,\sigma,s} \rangle.
\end{align}
