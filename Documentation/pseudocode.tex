...
Set the Hamiltonian, lattice and fields:\\
\textbf{Call} fields\_init\\
\textbf{Call} ham\_set\\
Read in an auxiliary-field configuration or generate it randomly:\\
\textbf{Call} nsigma\%in\\
...
\hspace*{2em} \textbf{If} performing tempering \textbf{then}\\
\hspace*{3em} \textbf{Call} exchange\_step \\
\hspace*{2em} \textbf{If} performing global updates \textbf{then}\\
\hspace*{3em} \textbf{Call} global\_updates \\
...
\hspace*{3em} Repeat the above steps (propagation, update, stabilization, equal-time measurements) \\
...
\hspace*{1em} \textbf{Call} nsigma\%out\\
