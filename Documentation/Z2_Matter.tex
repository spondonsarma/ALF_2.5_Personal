...
Ising  $\hat{Q}_{\ve{i}}$  variables.    The pyALF python script that produces this data can be found in  \href{https://git.physik.uni-wuerzburg.de/ALF/pyALF/-/blob/\pyALFbranch/Scripts/Z2_Matter.py}{\texttt{Z2\_Matter.py}}.
