...
\texttt{/Libraries/Modules/\allowbreak{}maxent\_stoch.f90} contains  a general implementation and  the wrapper  \texttt{Analysis/Max\_SAC.f90}. 
...
\subsubsection{Zero temperature, projective code}
