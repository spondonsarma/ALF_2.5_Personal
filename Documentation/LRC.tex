...
In the above,   $\Phi_i $ is a  real  variable.  The implementation follows Ref.~\cite{Hohenadler14}  but now supports various lattice geometries.    Importantly,  we note that $V$ has to be  positive definite.  
