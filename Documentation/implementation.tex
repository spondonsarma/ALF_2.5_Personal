...
\begin{table}[h]
	...
	\begin{tabular}{@{} l l l @{}}\toprule
		...
		\texttt{Field\%amplitude} &  Real    & Width of a random flip for fields of type \texttt{t=3}, defaults to \texttt{1}. \vspace{7pt} \\ %\bottomrule
	%\end{tabular}
	%\begin{tabular}{@{} l l @{}}\toprule	
		Function/Routine      & &    \hspace{107.8mm}  \\\midrule
