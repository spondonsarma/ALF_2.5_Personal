...
\begin{table}[h]
   ...
   \end{tabular}
   \caption{Overview of the subprograms of the  module \texttt{Hamiltonian\_Examples\_mod} to define the Hamiltonian, the lattice and the observables. The \hl{highlighted} subroutines may have to be modified by the user. \red{COMPLETE TABLE -- it should list all subroutines.}
