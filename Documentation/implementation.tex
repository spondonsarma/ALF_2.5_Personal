...
\begin{table}[h]
	...
	Be aware: When creating the observable with the subroutine \texttt{Obser_Latt_make},
	\texttt{Latt} and \texttt{Latt_unit} don't get copied but linked, meaning changing them after making the
