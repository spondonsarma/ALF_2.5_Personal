...
\begin{center}
 \begin{tabular}{ p{0.25\columnwidth} p{0.51\columnwidth} p{0.15\columnwidth} } 
   ...
   \texttt{Pr\_obs}   &
      ...
      Reconstruction of the weight for `inactive' flavors. &    \\    
      \texttt{GR\_reconstruction}   &
      Reconstruction of the Greens function GR for the `inactive' flavors. &    \\    
      \texttt{GRT\_reconstruction}   &
      Reconstruction of the time-displaced Greens functions G0T and GT0. & 
 \\\bottomrule   
 \end{tabular}
