...
\begin{table}[h]
   ...
   \begin{tabular}{@{} l l l l @{}}\toprule
    ...
    \texttt{Obs\%Ave\_sign}               & \texttt{dble}  &    Cumulated average sign [Eq.~\eqref{eqn:sign_rw}] & $\text{sign}(C)$  \\
    \texttt{Obs\%Obs\_vec(:)}  		      & \texttt{cmplx} &    Cumul. vector of observables [Eq.~\eqref{eqn:obs_rw}] &
