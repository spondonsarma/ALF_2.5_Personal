...
\begin{table}[h!]
	\begin{center}
		\begin{tabular}{@{} p{0.12\columnwidth} p{0.07\columnwidth} p{0.75\columnwidth}  @{}}\toprule
			...
			\texttt{WF\%Degen}     & \texttt{dble}  &  It stores the energy difference between the last occupied and first un-occupied single particle state and can be used to check for degeneracy.\\\bottomrule
		\end{tabular}
