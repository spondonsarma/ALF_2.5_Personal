...
%-------------------------------------------------------------------------------------
At  zero  chemical  potential,  and  for  repulsive  interactions,    the plain-vanilla   Hubbard  model  enjoys a  partial  particle-hole  symmetry  that  
for  each HS  field  configuration,  maps one  flavor    one  flavor  (i.e.  spin  sector)  onto  the other:      
\begin{equation} 
...
degree of  freedom,  
the anti-unitarity of the   transformation is   required.    A   consequence  of  this    symmetry,  and for  a  given  HS  field configuration, the  following holds for  the  equal  time Green function. 
