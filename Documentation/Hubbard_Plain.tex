...
%-------------------------------------------------------------------------------------
At  zero  chemical  potential,  and  for  repulsive  interactions,    the plain-vanilla   Hubbard  model  enjoys a  particle-hole  symmetry  that  maps,  for each  
HS  field  configuration,     one  flavor  (i.e.  spin  sector)  onto  the other.      
\begin{equation} 
...
Note  that   in the presence  of  an  orbital magnetic field, or  of   twisted boundary conditions  that  couples  symmetrically  to  the  spin  degree of  freedom,  
the anti-unitarity of the   transformation is   required.    A   consequence  of  this    symmetry,  and for  a  given  HS  field configuration we  have the   relations  for the   equal  time   Green  functions: 
