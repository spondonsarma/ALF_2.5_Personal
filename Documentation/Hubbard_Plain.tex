...
As stated in Sec. \ref{sec:hamiltonian}, for defining a new model one needs to 
\begin{enumerate}
...
\end{enumerate}
Where \emph{New\_model} is the designation of the new model, in this example \path{Hubbard_Plain_Vanilla}. There is a template \path{Prog/Hamiltonians/Hamiltonian_##NAME##_smod.F90} that can be copied for creating a new model.
