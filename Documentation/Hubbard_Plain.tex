...
The  executable \texttt{Hubbard\_Plain\_Vanilla.out}


To test the code, one can carry out   high precision  simulations.  
To  compile and run the code, it is convenient to use \texttt{pyALF}: \red{[Should we declare Run.py legacy, and substitute it by dedicated python scripts?]}
