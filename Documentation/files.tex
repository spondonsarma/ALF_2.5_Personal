...
%------------------------------------------------------------
%
The standard output files are listed in Table~\ref{table:output}. Notice that, besides these files, containing direct QMC outputs, ALF can also produce a number of analysis output files, discussed in Sec.~\ref{sec:analysis}.
