...
\begin{table}[h]
   ...
   \path{data.h5}     & Contains the same information as the scalar, equal-time correlation and time-displaced correlation operators as in Tab.~\ref{table:output}, but in one single HDF5 file (see also Fig.~\ref{fig_data_h5})\\
