...
Model        = "Hubbard"    ! Sets Nf=1, N_sun=2. HS field couples to the density
/
...
!HS      = "Mz"             ! If uncommented, sets the M_z-Hubbard model: Nf=2, N_sun=1, 
                            ! HS field couples to the z-component of magnetization
ham_T    = 1.d0             ! Hopping parameter
ham_chem = 0.d0             ! Chemical potential
ham_U    = 4.d0             ! Hubbard interaction
ham_T2   = 0.d0             ! For bilayer systems
