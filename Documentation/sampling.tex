...
For the analysis of the Monte Carlo data (see Sec.~\ref{sec:analysis}), the user can provide a finite value for \path{N_auto} to trigger the computation of  autocorrelation functions $S_{\hat{O}}(t_{\textrm{QMC}})$ in the range $t_{\text{QMC}}=[0,\textrm{\path{N_auto}}]$. 
