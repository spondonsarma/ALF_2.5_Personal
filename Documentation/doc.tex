...
%\RedeclareSectionCommands[tocdynnumwidth]{section,subsection}
...
%%%%%%%%\appendix
%\gdef\thesubsection{Appendix~\Alph{subsection}}
\gdef\thesubsection{\Alph{subsection}}
%\makeatletter
%\addtocontents{toc}{\protect\patchcmd{\protect\l@section}{1.5em}{\widthof{\textbf{Appendix X\quad}}}{}{}}
%\makeatother
\begin{appendices}
\input{performance}
\input{license}
