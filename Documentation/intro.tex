...
Apart from the canonical Hubbard model, 
\cite{Scalpino07} 
cold atomic gasses  \cite{Rigol03}
 the phenomena  one can investigate in detail include correlation effects in the bulk and surfaces of topological insulators \cite{Hohenadler10}, quantum phase transitions between semimetals (Dirac fermions)  and insulators \cite{},  
