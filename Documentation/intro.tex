...
The approach we will consider here, lies between the  above \textit{extremes}.  We will keep the fermion determinant, but formulate  the problem so as to  work only with $N\times N$ matrices.    This 
