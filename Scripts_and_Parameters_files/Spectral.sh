Name=(R_Channel R_Om_st R_Om_en )

for File_sr in  "Green"  "SpinZ" ; do
...
let n=0
for K in "0.00_0.00" "0.14_0.00" "0.27_0.00" "0.41_0.00" "0.55_0.00" "0.68_0.00" "0.82_0.00" "0.96_0.00" "1.09_0.00" \
         "1.23_0.00" "1.37_0.00" "1.50_0.00" "1.64_0.00" "1.78_0.00" "1.91_0.00" "2.05_0.00" "2.19_0.00" "2.32_0.00" \
         "2.46_0.00" "2.60_0.00" "2.73_0.00" "2.87_0.00" "3.01_0.00" "3.14_0.00" ; do
